...
4	Frantoio cloud3                         	cloud	258	\N	\N	\N	\N	t	\N	\N	2025-04-18 15:29:46.647	2025-04-18 15:29:46.647
\.
...
1	EXT	Olio extra vergine di oliva
...
1	SCHEMA_VERSION	5	Versione dello schema del database	SYSTEM	2025-04-18 13:29:26.969	2025-04-18 13:29:27.002
...
11	DOP  	DOP/IGP	f
12	ADD  	Olio/olive atto a divenire DOP/IGP	f
13	DOE  	DOP/IGP (Estero)	f
1	PUE  	Paese dell' Unione europea	f
2	UE   	Unione europea	f
3	EXT  	Paese extra Unione europea	f
4	MXUE 	Miscela di oli di oliva originari dell' Unione europea	f
5	CUE  	Combinazione Stati dell‟Unione europea/o regione dell‟Unione europea	f
6	MXN  	Miscela di oli di oliva non originari dell‟Unione europea	f
7	CEX  	Combinazione Stati non dell‟Unione europea/o regione extra Unione	f
8	MXX  	Miscela di oli di oliva originari dell' Unione europea e non originari dell‟Unione	f
9	CCE  	Combinazione Stati extra UE e UE/ combinazione di Regioni extra UE e UE	f
10	OSP  	Olio (extra) vergine ottenuto nell‟Unione (o in un Stato membro) da olive raccolte nell‟Unione (o in un Stato membro o in un paese terzo)	f
\.
...
2	Gabriele            	Baccino             	2	gb	$2b$10$AlaIijOc/3DTef5eY9Aa5OAL2FozTcNU0YpYIgGe28rzryHZZU.zy	g.baccino@cloud3.srl	2025-04-19 05:07:24.34	2025-04-18 14:16:10.323	2025-04-19 05:07:24.341	\N	f	f	\N
1	Amministratore      	Sistema             	1	admin	$2b$10$1F2VGZjvlcslTFcUA.z6jOV.CNLkUxO9j0kOykYQlFSf7aY8tOML.	admin.cloud@adhocoil.com	2025-04-19 05:39:04.885	2025-04-18 13:28:11.823	2025-04-19 05:39:04.886	\N	f	f	\N
\.
...
SELECT pg_catalog.setval('public.articoli_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.aziende_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.olive_to_oli_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.syslog_id_seq', 82, true);
...
SELECT pg_catalog.setval('public.user_aziende_id_seq', 1, true);
